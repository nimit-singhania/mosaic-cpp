...
main: train.cpp src/*.cpp alglib-cpp/src/*.cpp include/*.hpp
	g++ -std=c++11 -O3 -I include/ -I alglib-cpp/src/ src/*.cpp alglib-cpp/src/*.cpp train.cpp -o main -DCHECK -lboost_json #-DAE_CPU=AE_INTEL -mavx2 -mfma -DAE_OS=AE_POSIX -pthread 
